...
#   curl -sSL https://raw.githubusercontent.com/coltz108/ClawAV/main/scripts/oneshot-install.sh | sudo bash -s -- --version v0.2.9b
...
install_sudoers_allowlist() {
    ...
    if [[ -f /etc/sudoers.d/clawav-deny ]]; then
        ...
        log "Removed old clawav-deny (consolidated into hardened sudoers)"
    fi
